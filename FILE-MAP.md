...
| `reports` | The Phase 1 self-audit (security, money/lifecycle, domain, tests, docs, architecture) and the fix plan that tracks it. `reports/phase1-audit/FIX-PLAN.md` also records how each owner decision it raised was answered. |
