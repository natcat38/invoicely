...
| `web` | Phase 2 React UI (Vite + TypeScript + Tailwind 4 + shadcn/ui). Design tokens live in `web/src/index.css`; `web/src/lib/api.ts` is the only module that talks to the API. |
